...
func (sq *SeatQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (sq *SeatQuery) FirstIDX(ctx context.Context) int64 {
...
func (sq *SeatQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (sq *SeatQuery) OnlyIDX(ctx context.Context) int64 {
...
func (sq *SeatQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (sq *SeatQuery) IDsX(ctx context.Context) []int64 {
	ids, err := sq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (sq *SeatQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(seat.Table, seat.Columns, sqlgraph.NewFieldSpec(seat.FieldID, field.TypeInt64))
	_spec.From = sq.sql
...
func (sq *SeatQuery) Modify(modifiers ...func(s *sql.Selector)) *SeatSelect {
...
// Modify adds a query modifier for attaching custom logic to queries.
func (ss *SeatSelect) Modify(modifiers ...func(s *sql.Selector)) *SeatSelect {
